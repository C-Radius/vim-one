...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:syntax_bg     = ['#001e2127', '16'] "This is all line numbers bg highlight color
    let s:syntax_gutter = ['#1c1e20', '60']
    let s:syntax_cursor = ['#001e2127', '16'] "This is the selected line's background highlight color
    ...
    let s:syntax_bg     = ['#00fafafa', '255']
    let s:syntax_gutter = ['#9e9e9e', '247']
    let s:syntax_cursor = ['#00f0f0f0', '254']
